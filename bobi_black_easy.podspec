...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/Miles-Matheson/bobi.black.oc.easy.git", :tag => "0.0.22" }
  ...
  s.subspec 'Addocshugenbro' do |spec|
	...
	core.source_files   = "bobi_black_easy/Classes/Addocshugenbro/Category/*.{h,m,mm,a,pch}"
	core.source_files   = "bobi_black_easy/Classes/Addocshugenbro/Vender/**/*.{h,m,mm,a,pch}"
	core.source_files   = "bobi_black_easy/Classes/Addocshugenbro/YCXMenu/*.{h,m,mm,a,pch}"
