...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(actionRealSendMsg) name:SendMessageSendedStatuas object:nil];
}
...
- (void)inputBar:(TUIInputBar *)textView didSendText:(NSString *)text
{
    ...
    if(_delegate && [_delegate respondsToSelector:@selector(inputController:didSendMessage:)]){
        [[NSUserDefaults standardUserDefaults]setValue:text forKey:SendMessageContent];
        [[NSUserDefaults standardUserDefaults]synchronize];
        [[NSNotificationCenter defaultCenter]postNotificationName:SendMessageSendingStatuas object:nil];
        [_delegate inputController:self didSendMessage:data];
    }
}
-(void)actionRealSendMsg
{
    NSLog(@"actionRealSendMsgactionRealSendMsgactionRealSendMsgactionRealSendMsg");
//    NSString *text = [[NSUserDefaults standardUserDefaults]valueForKey:SendMessageContent];
//    NSString *content = [self faceContentWithLocalizableString:text];
//    TUITextMessageCellData *data = [[TUITextMessageCellData alloc] initWithDirection:MsgDirectionOutgoing];
//    data.content = content;
//    if(_delegate && [_delegate respondsToSelector:@selector(inputController:didSendMessage:)]){
