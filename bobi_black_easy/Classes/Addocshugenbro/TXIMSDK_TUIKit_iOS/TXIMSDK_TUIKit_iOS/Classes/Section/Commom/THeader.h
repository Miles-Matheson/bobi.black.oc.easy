...
#define kHScale Screen_Height/667.0f
#define kHSizeRatio(value) value * kHScale //全局高度缩放比

#define WhiteColor HexString(@"#FFFFFF")
//字符串是否是空
...
#define NeighborsSimple_VPN         @"Nsc_VPN"
#define NeighborsSimple_COUNTRY     @"Nsc_Country"
#define NeighborsSimple_UploadImage @"NeighborsSimple_UploadImage"
...
#define NSC_Base_Url  @"http://www.matthewone.cn/fate/"
...
#define CXSLocalMemberMute                      @"CXSLocalMemberMute"
...
#define WeakSelf2(type)  __weak typeof(type) weak##type = type;
...
#define SendMessageSpareq10th      @"SendMessageSpareq10th"
#define SendMessageMemberLevel     @"SendMessageMemberLevel"
#define SendMessageContent         @"SendMessageContent"
#define SendMessageSendingStatuas  @"SendMessageSendingStatuas"
#define SendMessageUpgrade          @"SendMessageUpgrade"
#define SendMessageUpgrade2          @"SendMessageUpgrade2"
#define SendMessageSendedStatuas   @"SendMessageSendedStatuas"
